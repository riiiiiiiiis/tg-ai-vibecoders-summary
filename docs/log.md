...
- Создано 6 хелперов: ~92 строки
- Упрощены 3 форматтера: ~199 строк
- Чистая экономия: ~99 строк

**Что сделано:**
- ✅ 6 хелперов для Telegram форматирования
- ✅ Упрощены 3 форматтера (standard, persona, daily-summary)
- ✅ Код компилируется без ошибок

**Что осталось на День 2:**
- ⏳ Промпты - вынести общие части (~4ч)
- ⏳ JSON схемы - упростить (~3ч)
